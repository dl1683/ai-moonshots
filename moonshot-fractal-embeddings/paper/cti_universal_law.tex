...
(2-competitor localisation; \S\ref{subsec:competition-field}) and the kernel-showdown
finding ($k^*=2$ dominant rivals), independently confirming that 2--4 near competitors
