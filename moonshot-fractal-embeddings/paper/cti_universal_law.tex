...
\textbf{Constant}: $A_{\mathrm{renorm,bio}}\approx0.03$--$0.07$ vs $A_{\mathrm{renorm,NLP}}=1.13$ ($15$--$34\times$ smaller) --- gradient training optimises the constant; the geometric skeleton is preserved. See Figure~\ref{fig:allen-bio}.
