...
Empirically, leave-one-architecture-out (LOAO) over 12 NLP architectures (transformers, SSM hybrid, pure-RNN RWKV-4, 125M--7B params, 2021--2025) yields $\hat\alpha=1.477\pm0.034$, CV$=0.019$ --- 13$\times$ below the pre-registered threshold of 0.25.
RWKV's held-out $\hat\alpha=2.887$ falls within the pre-registered acceptance interval $[2.43,3.29]$.
