...
\item \textbf{K-scaling and practical prediction}: The slope $A(K)=1.164/\log(K)+1.301$ ($r_\mathrm{fit}=0.93$) predicts held-out dataset slopes within 50\%. One-shot dataset calibration (one anchor architecture) achieves MAE$\leq$0.08 for all tested single-label datasets.
\end{enumerate}
