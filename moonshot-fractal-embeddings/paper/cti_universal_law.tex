...
Direct centroid-geometry measurement of $N_\mathrm{eff}$ (requiring the full $K\times K$ pairwise
distance matrix, not just $\kappa_\mathrm{nearest}$) is a planned follow-up
that would provide the most direct mechanistic test.
