...
Among 19 tested model families, BERT and GPT-2 do not follow the law (BERT's CLS token is not class-separable without fine-tuning; GPT-2's final layer degenerates for classification). The law applies to the class of modern autoregressive NLP decoders and, in functional form, to attention and convolutional vision architectures.
