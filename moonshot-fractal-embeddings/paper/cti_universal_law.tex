...
Pointwise MAE is close to the dataset-mean baseline (CTI 0.081 vs.\ baseline 0.084), confirming that the law captures \emph{mechanistic ordering} rather than high-precision calibration; the geometric signal (kappa) explains within-dataset architecture variation that dataset means cannot, while cross-dataset variance is dominated by $C_d$.
