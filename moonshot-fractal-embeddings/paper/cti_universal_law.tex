...
Pointwise MAE is close to the dataset-mean baseline (CTI 0.077 vs.\ baseline 0.079), confirming that the law captures \emph{mechanistic ordering} rather than high-precision calibration.
CTI's unique value emerges in within-dataset architecture ranking: on the four datasets with meaningful cross-architecture variation (spread${}>0.20$), CTI achieves mean Spearman $\rho=0.642$ (20newsgroups: $0.912$, Amazon Massive: $0.733$, DBpedia: $0.444$, Banking77: $0.479$), while the dataset-mean baseline provides $\rho=0$ by definition.
