...
V5 enables practical two-stage pipelines: fast $4\times$-cheaper coarse filtering at 64d, followed by fine reranking at 256d only where needed.
...
Table~\ref{tab:threelevel} shows that V5 exhibits a clear \emph{ramp gradient}: the $L_2$ (intent) accuracy ramp from 64d to 256d is $+3.2$pp, the $L_1$ (domain) ramp is $+1.0$pp, and the $L_0$ (super-domain) ramp is $+0.5$pp.
MRL is flat at all levels ($\leq 0.4$pp ramp).
The 3-level steerability $\steer_{02} = +0.027 \pm 0.004$ (V5) vs.\ $+0.002 \pm 0.004$ (MRL, 3~seeds), confirming that fractal supervision generalizes to deeper hierarchies.
