...
Steerability increases monotonically with hierarchy complexity ($\hlo$): from $\steer = +0.015$ on Yahoo ($\hlo = 1.23$) to $\steer = +0.144$ on CLINC ($\hlo = 3.90$).
...
A linear fit yields $\steer \approx 0.051 \cdot \hlo - 0.062$ ($R^2 = 0.96$).
