...
This is an \emph{impossibility} property of the training objective, not a limitation of the model: $4.5\times$ more trainable parameters cannot break the symmetry.
