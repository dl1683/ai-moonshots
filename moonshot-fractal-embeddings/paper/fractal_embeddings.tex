...
Across twelve hierarchical datasets, steerability improvements are consistent and large (meta-analytic $d = 1.87$, $p < 10^{-6}$; sign test $12/12$, $p < 0.001$), and four causal ablations confirm the mechanism ($p_\text{adj} < 10^{-3}$, $d \geq 6.1$).
...
\begin{enumerate}
    ...
    \item \textbf{Causal and cross-dataset evidence}: twelve datasets, meta-analytic $d = 1.87$ ($p < 10^{-6}$), sign test $12/12$ ($p < 0.001$), and four ablations confirming alignment as the mechanism ($d \geq 6.1$; Section~\ref{sec:causal}).
