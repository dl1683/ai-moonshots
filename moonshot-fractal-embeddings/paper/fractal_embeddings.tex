...
\paragraph{Datasets.}
Table~\ref{tab:datasets} summarizes our evaluation datasets, spanning conditional entropies from 1.23 (Yahoo~\citep{zhang2015yahoo}) to 3.90 bits (CLINC-150~\citep{larson2019clinc}), also including TREC~\citep{voorhees2000trec} and 20 Newsgroups.
